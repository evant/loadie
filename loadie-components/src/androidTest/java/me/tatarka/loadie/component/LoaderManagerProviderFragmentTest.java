...
public class LoaderManagerProviderFragmentTest {

    @Rule
    public ActivityTestRule<TestActivityWithFragment> activityRule = new ActivityTestRule<>(TestActivityWithFragment.class);
    ...
    public void loader_manager_detaches_loaders_on_config_change() {
        LoaderManager loaderManager = activityRule.getActivity().fragment.loaderManager;
        ...
        i.runOnMainSync(new Runnable() {
            ...
            public void run() {
                activityRule.getActivity().getSupportFragmentManager().beginTransaction()
                        ...
                        .commitNow();
                activityRule.getActivity().getSupportFragmentManager().beginTransaction()
                        .attach(activityRule.getActivity().fragment)
                        .commitNow();
            }
        });
        i.waitForIdleSync();
